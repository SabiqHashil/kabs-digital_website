...
const Footer = () => {
  ...
  return (
    <footer className="bg-[#fafafa] py-10  px-8 md:px-0 md:mx-auto border-t">
      <div className="flex flex-row  justify-between gap-y-3 xl:w-4/5 2xl:w-[68%] mx-auto">
        ...
        <div className="flex items-center space-x-4">
          <h2 className="text-sm md:text-lg lg:text-xl xl:text-xl font-semibold text-gray-700">Follow Us:</h2>
          <FloatingDockDemo />
        </div>

      </div>

      <div className="flex md:justify-center gap-x-4 mt-10 text-sm text-center text-gray-600">
